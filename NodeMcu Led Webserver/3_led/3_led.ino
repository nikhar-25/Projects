...
const char* ssid = "MAHENDRA";  // Enter SSID here
const char* password = "9456944904";  //Enter Password here
...
void setup() {
  ...
  Serial.print("Use This Web Address to use the web server:");
...
String SendHTML(uint8_t led1stat,uint8_t led2stat,uint8_t led3stat){
  ...
  ptr +="</head>\n";
  ptr +="<body>\n";
  ptr +="<h1>NODEMCU LED Web Server</h1>\n";
  ptr +="<h3>CLICK ON BUTTON BELOW TO TURN LED ON AND OFF</h3>\n";
